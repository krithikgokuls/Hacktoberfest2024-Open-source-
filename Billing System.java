    ...
    static void cashierfunc()
    {
        ...
        while(true)
        {
            ...
            else if(choice==5)
            {
                ...
                int n=5,i,j;
                System.out.println("Stock Name     Stock Count     Single Price        Tax          Total");
                fb.printf("Stock Name     Stock Count     Single Price        Tax          Total\n");
                for(Object k:al)
                {
                  ...
                  for( i=0;i<((ArrayList)k).size();i++)
                    {
                        ...
                        if(i==((ArrayList)k).size()-1){
                         System.out.println("======================================================================");
                          System.out.println("                                                  THE TOTAL :"+((ArrayList)((ArrayList)k).get(i)).get(5));
                          fb.printf("                                                    THE TOTAL :%-5f\n",((ArrayList)((ArrayList)k).get(i)).get(5));
                        }
                    }
                    System.out.println("======================================================================");
                }
